...
<%@page import="database.model.Review"%> <%-- Assure-toi d'importer la classe Review --%>
<!DOCTYPE html>
<html>
    <head>
                ...
                <% for (Review opinion : opinions) { %>
                    <div class="opinion-card">
                        ...
                        <div class="opinion-card-header">
                            Opinion de <%= opinion.getUser().getLastName() %> <%= opinion.getUser().getFirstName() %> 
                        </div>
                        ...
                        <div class="opinion-field date-visite">
                            ...
                            <span class="opinion-field-value"><%= opinion.getDateVisite() %></span>
                        </div>
